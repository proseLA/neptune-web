...
<h2 id="polyfills-for-web-browser-api">Polyfills for Web / Browser API</h2>
...
<table className="docs-table table">
  ...
  <tbody>
    <tr>
      <td>
        <DocLink href="components/context/Provider">Provider</DocLink>
      </td>
      <td>
        <ul>
          <li>
    ...
    <tr>
      <td>
        <DocLink href="components/content/Image">Image</DocLink>
      </td>
      <td>
        <ul>
          <li>
    ...
    <tr>
      <td>
        <DocLink href="components/inputs/Upload">Upload</DocLink>
      </td>
      <td>
        <ul>
          <li>
