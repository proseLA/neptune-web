...
E.g. <code><h1 className="display-5"</code>
  ...
  <tbody>
    <tr>
      <td>
        <p>
          {' '}
          I am a <span class="font-weight-regular">regular</span> text
        </p>
    ...
    <tr>
      <td>
        <p>
          {' '}
          I am a <span class="font-weight-semi-bold">semi bold</span> text
        </p>
    ...
    <tr>
      <td>
        <p>
          {' '}
          I am a <span class="font-weight-bold">bold</span> text
        </p>
