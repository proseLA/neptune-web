...
FormControl.propTypes = {
  ...
  mode: PropTypes.oneOf([FormControl.DateMode.DAY_MONTH_YEAR, FormControl.DateMode.MONTH_YEAR]),
  ...
  monthFormat: PropTypes.oneOf([FormControl.MonthFormat.LONG, FormControl.MonthFormat.SHORT]),
